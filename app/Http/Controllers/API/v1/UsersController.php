...
class UsersController extends Controller
{
    ...
    public function register(UserRegisterRequest $request, UserRepository $userRepository): JsonResponse
    {
        try {
            ...
            return $this->response->success($token, 'Вы успешно зарегистрировались!', Response::HTTP_CREATED);
        } catch (Exception $e) {
    ...
    public function login(UserLoginRequest $request, UserRepository $userRepository): JsonResponse
    {
        try {
            ...
            return $this->response->success($token, 'Вы успешно авторизовались!', Response::HTTP_OK);
        } catch (Exception $e) {
            return $this->response->error($e->getMessage(), Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public function profile(UserRepository $userRepository): JsonResponse
    {
        try{
            ...
            return $this->response->success($user, 'Данные пользователя', Response::HTTP_OK);
        } catch (Exception $e) {
            return $this->response->error($e->getMessage(), Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
